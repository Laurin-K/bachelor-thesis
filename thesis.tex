...
\newcommand{\titel}{Analyse von Gamificationelementen in Fitness- und Gesundheitsapps nach dem EMPAMOS Modell.}
\newcommand{\artderarbeit}{Bachelorarbeit}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{Laurin Horst Kerntke}
\newcommand{\studiengang}{Informatik}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
\newcommand{\matrikelnr}{538\,9214}
\newcommand{\erstgutachter}{Prof.\,Dr.~Thomas Voit}
...
\renewcommand{\lstlistlistingname}{Auslistung}  % change for German thesis
\lstlistoflistings
\cleardoublepage
